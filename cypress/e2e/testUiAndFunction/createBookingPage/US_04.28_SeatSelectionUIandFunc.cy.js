...
describe('US_04.28 | Seat selection UI and functionality', () => {
    ...
    it.only('In the "Seats table" the seats numbers in the horizontal row start with the same digit followed by a letter in alphabetical order (1A, 1B, 1C, 2A, 2B, 2C etc.)', function() {
